...
const Messages = () => {
  ...
  const getTotalUnreadCount = () => {
    return conversations.reduce((sum, conv) => sum + conv.unreadCountCompany, 0);
  };
        ...
        <div className="conversations-list">
              ...
              <div className="conv-details">
                ...
                <div className="conv-footer">
                  ...
                  {conv.unreadCountCompany > 0 && (
                    <span className="unread-badge">{conv.unreadCountCompany}</span>
                  )}
                </div>
              </div>
            </div>
          ...
          {conversations.length === 0 && (
            <div className="no-conversations">
              ...
              <p>Apply to projects to start messaging</p>
            </div>
          )}
        </div>
      </div>
            ...
            <div className="chat-header">
              <div className="chat-header-info">
                <div className="chat-avatar">
                  {activeConversation.client.name.charAt(0).toUpperCase()}
                </div>
                <div>
                  <h3>{activeConversation.client.name}</h3>
