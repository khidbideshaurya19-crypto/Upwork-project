      ...
      <nav className={`lp-nav${scrolled ? ' lp-nav--scrolled' : ''}`}>
        <div className="lp-nav-inner">
          ...
          <div className={`lp-nav-right${mobileOpen ? ' lp-nav-right--open' : ''}`}>
            ...
            <button className="lp-btn-get-started" onClick={() => navigate('/signup')}>Get Started Free</button>
          </div>
      ...
      <header className="lp-hero">
        ...
        <div className="lp-hero-inner">
          ...
          <div className="lp-hero-actions">
            ...
            <button className="lp-btn-hero-outline" onClick={() => navigate('/signup')}>Join as Company</button>
          </div>
      ...
      <section className="lp-cta-band">
        ...
        <div className="lp-section-inner lp-cta-inner">
          ...
          <div className="lp-hero-actions">
            ...
            <button className="lp-btn-cta-ghost" onClick={() => navigate('/signup')}>Apply as Company</button>
          </div>
        </div>
      </section>
